...
const ProductDetail = () => {
  ...
  const getProductDetail = async() => {
    //0대신 아이디값은 항상 바뀌어야 하므로 동적으로
    let url = `https://my-json-server.typicode.com/anyounghwa/project7/products/${id}`;
  ...
  return (
    <Container className='mt-5'>
      ...
      <Row>
        ...
        <h2>의류 관리 가이드</h2>
        <p>여러분도 환경 보호를 돕고 더욱 지속 가능한 패션을 만들 수 있습니다. 불필요한 옷이나 가정용 직물을 H&M 매장에 가지고 오면 다시 입을 수 있는 옷을 만드는 데 사용되거나 재사용 또는 재활용됩니다.</p>
        <p>의류 관리법</p>
